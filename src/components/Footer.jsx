  ...
  return (
    <footer id='footer' className="bg-stone-100 border-t border-stone-200">
      <div className="max-w-7xl mx-auto px-6 pb-10">
        ...
        <div className="py-6">
          {/* Desktop Layout */}
          <div className="hidden md:flex flex-wrap items-center gap-x-6 gap-y-2 text-sm">
          ...
          <div className="md:hidden flex flex-col gap-3 text-sm">
            ...
            <a href="#sharing" className="text-stone-600 hover:text-stone-900 transition-colors">
              Sharing Settings
            </a>
            <a href="#accessibility" className="text-stone-600 hover:text-stone-900 transition-colors">
              Web Accessibility
            </a>
            <span className="text-stone-600 mt-2">
              © 2025 BetterHelp
            </span>
          </div>
        </div>
